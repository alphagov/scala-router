...
class RouterTest < Test::Unit::TestCase
  ...
  def test_creating_an_application_yields_an_application
    yielded = false
    Router.new("http://router.url").application("id", "http://app-backend.url") do |app|
      yielded = app
    end
  ...
  def test_creating_an_application_returns_the_application
    app = Router.new("http://router.url").application("id", "http://app-backend.url")
  ...
  def test_application_is_created_with_a_configured_router_client
    ...
    Router.new("http://router.url").application("id", "http://app-backend.url")
  end
  ...
  def test_application_is_created_with_application_id_and_backed_url
    ...
    Router::Application.expects(:new).with(anything, "id", "http://app-backend.url").returns(stub_everything)
  ...
  def test_should_register_application_with_router
    ...
    router.application("id", "http://app-backend.url") do |app|
    end
  end
end